<template>
  <div class="leftbar" :class="{ narrow: !$store.state.leftbar.wide }">
    <!-- 左侧导航菜单-展开 -->
    <el-menu v-if="$store.state.leftbar.wide" router unique-opened mode="vertical" theme="dark" :default-active="'/' + $route.path.split('/')[1]">
      <el-menu-item class="home" index="/home" @click="">
